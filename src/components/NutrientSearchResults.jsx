  ...
  useEffect(() => {
    const fetchNutrientSearchResults = async () => {
      try {
        ...
        const url = `/.netlify/functions/fetchNutrientSearchResults?query=${query}&minCalories=${calories[0]}&maxCalories=${calories[1]}&minCarbs=${carbs[0]}&maxCarbs=${carbs[1]}&minProtein=${protein[0]}&maxProtein=${protein[1]}&minFat=${fat[0]}&maxFat=${fat[1]}&offset=${offset}`;
